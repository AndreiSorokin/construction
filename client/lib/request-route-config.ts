...
const requestCreatorRoles: Record<SupplyRequestType, UserRole[]> = {
  MATERIAL: ["MECHANIC", "FOREMAN", "SITE_MANAGER", "WORKSHOP_MANAGER"],
  TRANSPORT: ["FOREMAN", "SITE_MANAGER", "WORKSHOP_MANAGER"],
  MONEY: ["MECHANIC", "FOREMAN", "SITE_MANAGER", "WORKSHOP_MANAGER"],
  ...
  FUEL: ["MECHANIC", "FOREMAN", "SITE_MANAGER", "WORKSHOP_MANAGER"],
